...
{
    public class UserLoginHistoryRepository : EntityRepositoryBase<UserLoginHistory, ProjectAppDbContext>, IUserLoginHistoryRepository
    {
        public UserLoginHistoryRepository(IMapper mapper) : base(mapper)
        {
        }
    }
}
